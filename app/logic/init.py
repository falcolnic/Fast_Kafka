...
from logic.queries.messages import (
    GetAllChatsListenerQuery,
    GetAllChatsListenerQueryHandler,
    GetAllChatsQuery,
...
def _init_container() -> Container:
    ...
    container.register(GetAllChatsListenerQueryHandler)
    ...
    def init_mediator() -> Mediator:
        ...
        mediator.register_query(
            GetAllChatsListenerQuery,
            container.resolve(GetAllChatsListenerQueryHandler),
        )
